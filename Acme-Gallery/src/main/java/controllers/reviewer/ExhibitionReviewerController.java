/*
 * ExhibitionReviewerController.java
 * 
...
@Controller
@RequestMapping("/exhibition/reviewer")
public class ExhibitionReviewerController extends AbstractController {

	private final String		ACTOR_WS	= "reviewer/";
