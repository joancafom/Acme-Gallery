...
<jstl:if test="${dayPass.exhibition ne null}">
...
<jstl:if test="${dayPass.exhibition eq null}">

<spring:message code="dayPass.museum.message"/> <a href="museum/visitor/display.do?museumId=${dayPass.museum.id}"><jstl:out value="${dayPass.museum.name}"/></a>.<br/>
<spring:message code="dayPass.priceWithTaxes"/> <acme:priceFormat code="price.format" value="${dayPass.price}"/>.<br/>

<form:form action="dayPass/${actorWS}edit.do?museumId=${dayPass.museum.id}" modelAttribute="dayPass">
	...
	<acme:submit name="save" code="dayPass.save"/>
	<acme:cancel url="museum/${actorWS}display.do?museumId=${dayPass.museum.id}" code="dayPass.cancel"/>
